...
const E29content = document.querySelector('#text') 
// get Element 
...
E29.addEventListener('click', () => { 
    ...
    E29content.innerHTML = " O cobre é um dos elementos mais abundantes da Terra, mas normalmente é encontrado na sua forma de mineral. Ele é utilizado pelas indústrias na produção de moedas, medalhas, produção de telhados e em fios para instalações elétricas e motores. O cobre pode ser reutilizado pelas indústrias quando é derretido para ser usado na produção de moedas."; 
})