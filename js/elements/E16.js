...
const E16content = document.querySelector('#text')
...
E16.addEventListener('click', () => {
    ...
    E16content.innerHTML = "O enxofre é um não metal que possui diversas funções na indústria, como: nas indústrias de pigmentação, celulose, petróleo e metalúrgica; produção de baterias, detergentes, fungicidas, cosméticos, explosivos e no tratamento da água. A principal forma de reutilização do enxofre é na reciclagem de baterias, já que o enxofre está presente na produção destas.";
})