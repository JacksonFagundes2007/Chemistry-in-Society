...
const E9utility = document.querySelector('#utility') 
const E9reuse = document.querySelector('#reuse') 
// get Element 
const E9 = document.querySelector('#E9') 
// Inner HTML 
E9.addEventListener('click', () => { 
    E9image.setAttribute('src', "https://cdn.discordapp.com/attachments/801974522839826484/893465632161534012/009.png") 
