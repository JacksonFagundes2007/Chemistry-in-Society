...
const E18utility = document.querySelector('#utility') 
const E18reuse = document.querySelector('#reuse') 
// get Element 
...
E18.addEventListener('click', () => { 
    ...
    E18utility.innerHTML = "Utilização: O Argônio é um gás nobre incolor e inodoro, sendo um dos gases nobres mais abundantes da terra,  que é utilizado em extintores de incêndio, lasers para tratamento de doenças oculares e datação de objetos."; 
    E18reuse.innerHTML = "Reutilização: Não pode ser reutilizado."; 
})