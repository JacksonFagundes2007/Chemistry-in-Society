...
const E79content = document.querySelector('#text')  
// get Element 
...
E79.addEventListener('click', () => {  
    ...
    E79content.innerHTML = " O ouro é um metal que não pode ser utilizado na sua forma pura, pois é muito mole. Por isso as indústrias endurecem formando ligas metálicas. O ouro então é utilizado em joalherias, fabricação de moedas e como padrão monetário em muitos países. O ouro é reutilizado nas indústrias eletrônicas, onde faz parte da produção dos laminados de placas de computadores.";  
})