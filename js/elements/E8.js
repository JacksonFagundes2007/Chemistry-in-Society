...
const E8utility = document.querySelector('#utility') 
const E8reuse = document.querySelector('#reuse') 
// get Element 
...
E8.addEventListener('click', () => { 
    ...
    E8utility.innerHTML = "Utilização: O oxigênio é utilizado por diversas indústrias por motivos diferentes. Na metalúrgica, o elemento ajuda nos processos de fundição, corte e solda; ainda na metalúrgica, o oxigênio aumenta a eficiência de diferentes processos porque reduz a quantidade de combustível necessária, além de reduzir as emissões de dióxido de carbono. Já na medicina, o oxigênio é utilizado no tratamento de insuficiência respiratória, na intoxicação por monóxido de carbono e em procedimentos de receptação. Nos laboratórios, o oxigênio é utilizado como: agente de branqueamento, combustível para detecção de chama, agente combustível para análise elementar, agente oxidante e para oxidação de silício na fabricação de semi condutores."; 
    E8reuse.innerHTMl = "Reutilização: O oxigênio ajuda no processo de Reciclagem química ( A reciclagem química é um processo em que os resíduos são alterados e transformados em matéria prima para produção de novos produtos). O oxigênio é inserido em um dos processos de Reciclagem química para que ocorra a combustão do carbono contido na matéria."; 
})