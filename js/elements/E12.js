...
const E12utility = document.querySelector('#utility') 
const E12reuse = document.querySelector('#reuse') 
// get Element 
...
E12.addEventListener('click', () => { 
    ...
    E12utility.innerHTML = "Utilização: O magnésio é um elemento químico conhecido por fazer parte da estrutura de aviões, mísseis, maquinários e ferramentas, mas o que poucos sabem é que o magnésio é usado em produtos químicos como agente redutor na produção de metais( titânio, zircônio, urânio, berílio, etc)."; 
    E12reuse.innerHTML = "Reutilização: O magnésio pode ser reutilizado na limpeza das ligas de cloro, onde é colocado uma pequena quantidade de magnésio para limpar essas ligas."; 
})