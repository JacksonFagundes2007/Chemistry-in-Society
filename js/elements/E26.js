...
const E26utility = document.querySelector('#utility') 
const E26reuse = document.querySelector('#reuse')  
// get Element 
const E26 = document.querySelector('#E26')  
// Inner HTML 
E26.addEventListener('click', () => {  
    E26image.setAttribute('src', "https://cdn.discordapp.com/attachments/801974522839826484/893465774927282206/026.png")  
    E26name.innerHTML = "Nome: Ferro";  
    E26token.innerHTML = "Símbolo: Fe";   
    E26atomicNumber.innerHTML = "Numero atômico: 26";  
    E26atomicMass.innerHTML = "Massa Atômica: 55.845";  
    E26utility.innerHTML = "Utilização: O Ferro faz parte do grupo dos Metais na Tabela Periódica, então apresenta característica comuns desse grupo como: ser um bom condutor de calor e eletricidade. Justamente por isso é utilizado na produção de aço, liga metálica para a produção de ferramentas, máquinas, veículos de transporte (automóveis, navios, etc.), como elemento estrutural de pontes, edifícios, e uma infinidade de outras coisas."; 
    E26reuse.innerHTML = "Reutilização: O ferro é utilizado na sua forma de aço. No Brasil existem dois processos diferentes de reciclagem de ferro: um voltado apenas para o reaproveitamento das latas de aço e outro para uso das siderúrgicas em geral.";  
})