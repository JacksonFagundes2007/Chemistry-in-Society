...
const E22content = document.querySelector('#text') 
// get Element 
...
E22.addEventListener('click', () => { 
    ...
    E22content.innerHTML = "O titânio é um metal conhecido por ser resistente, e ele é mesmo. Justamente por ser resistente, ele é usado na indústria aeroespacial (na formação das estruturas de aviões e turbinas para aviões supersônico). Mas suas aplicações não ficam apenas na indústria aeroespacial, já que ele é utilizado em implantes dentários, está presente na composição de joias e é utilizado em tratamentos de câncer. O titânio é reutilizado quando é retirado dos ossos de pessoas mortas. Quando uma pessoa com dentes, joelhos ou qualquer outro osso com titânio implantado cirurgicamente morre, seus ossos com o metal são retirados e reciclados."; 
})