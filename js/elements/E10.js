...
const E10utility = document.querySelector('#utility') 
const E10reuse = document.querySelector('#reuse') 
// get Element 
...
E10.addEventListener('click', () => { 
    ...
    E10utility.innerHTML = "Utilização: O Neônio é um gás nobre, pouco presente na atmosfera, mas abundante no universo. Sua principal utilização é nas lâmpadas neon , mas também é utilizado na produção de lasers."; 
    E10reuse.innerHTML = "Reutilização: Não pode ser reutilizado."; 
})