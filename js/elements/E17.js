...
const E17content = document.querySelector('#text')
...
E17.addEventListener('click', () => {
    ...
    E17content.innerHTML = "O cloro é um elemento químico famoso por estar na composição de desinfetante, bactericida e clareador, mas ele é usado na produção de PVC desde 1930.  o PVC é um material sustentável, menos dependente do petróleo do que qualquer outro termoplástico. Sua principal reutilização é no formato de PVC, onde pode ser reutilizado de duas maneiras: Na energética, onde retira-se o calor intrínseco do PVC, que pode ser transformado em energia elétrica, e na reciclagem mecânica transforma o produto de PVC em um novo, sem processo químico.";
})