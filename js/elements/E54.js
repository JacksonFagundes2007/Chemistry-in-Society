...
const E54utility = document.querySelector('#utility') 
const E54reuse = document.querySelector('#reuse') 
// get Element 
...
E54.addEventListener('click', () => { 
    ...
    E54utility.innerHTML = "Utilização: O xenônio é um elemento membro do grupo dos gases nobres, ele é utilizado em anestesias,  em instalações nucleares,  na propulsão de foguetes, sendo estudada a possibilidade de incluí-los em tratamentos contra a depressão, o transtorno do pânico e outras doenças psiquiátricas."; 
    E54reuse.innerHTML = "Reutilização: Não pode ser reutilizado."; 
})